...
return [
    ...
    'title' => env('MOONSHINE_TITLE', 'Админпанель Skaenergy.ru'),
    ...
    'footer' => [
        'copyright' => 'Made with ❤️ by <a href="https://inshin.org/" class="font-semibold text-purple hover:text-pink" target="_blank">Inshin</a>',
        'nav' => [
