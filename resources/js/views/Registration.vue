            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8 w-full lg:w-[21rem]">
                ...
                <form class="space-y-4 md:space-y-4">
                    ...
                    <div>
                        ...
                        <button type="button"
                                class="text-white bg-[#1da1f2] w-full justify-center hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 rounded-lg text-sm p-2.5 inline-flex mb-2">
                            <svg class="w-4 h-4 mr-2 -ml-1" aria-hidden="true" focusable="false" data-prefix="fab"
                        ...
                        <button type="button"
                                class="text-white bg-[#2e6ab7] w-full justify-center hover:bg-[#2e6ab7]/90 focus:ring-4 focus:outline-none focus:ring-[#2e6ab7]/50 rounded-lg text-sm p-2.5 inline-flex mb-2">
                            <svg class="w-4 h-4 mr-2 -ml-1" aria-hidden="true" focusable="false" data-prefix="fab"
